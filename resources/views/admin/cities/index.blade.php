...
@section('body')
<button class="btn btn-success mt-2 mb-2 ml-3" data-target="#addCompany" data-toggle="modal">+ زيادكردن</button>
    ...
    <table class="col-12 text-center ">
        ...
        <tbody>
           ...
           <tr>
                ...
                <th>{{$city->user->username}}</th>
                <th class="ltr">{{$city->created_at->diffForHumans()}}</th>
                <th><a href="{{route('cities.show',$city->city_id)}}" class="btn btn-warning text-dark">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{-- form --}}
                    <form action="" method="POST" class="ltr" action="{{route('cities.store')}}" id="form1">
                        @csrf
                        <div class="form-group">
                            <input class="form-control  text-center" placeholder="ناو" type="text" name="city_name">
                        </div>
    ...
    $('#form1').submit(function (e) { 
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $('tbody').prepend('<tr><th>'+response.shar+'</th><th>'+response.name+'</th>'
