    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                {{-- form --}}
                <form action="" method="POST" class="ltr" action="{{route('office.store')}}" id="form1" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <input class="form-control  text-center" placeholder="ناو" type="text" name="name">
                    </div>
            ...
            success: function (response) {
               if(response.message!="failed"){
                ...
                $('tbody').prepend(' <tr><th>'+response.name+'</th>'
                                           +'<th>'+response.address+'</th><th>'+response.phone_number+'</th><th>'+response.user.username+'</th>'
